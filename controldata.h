...
/*
 * These messages inform the jukebox what kind of 
 * audio is being played.
 */
#define INFO_BITRATE     100
#define INFO_FREQUENCY   101
#define INFO_CRC         102
#define INFO_COPYRIGHT   103
#define INFO_MODE        104
#define INFO_ORIGINAL    105
#define INFO_IDENT       106
 ...
 *
 * !NOTE. I'm going to remove this. To hard to expand and do something
 *        useful with.
 * MSG_INFO
 ...
 *
 * !NOTE. I'm going to use this.
 *        The INFO messages can be sent anytime during play. They should
 *        probably be sent during initialization of a new song though.
 * INFO_BITRATE
 *   This message can be sent by the player to the jukebox to inform it
 *   what bitrate is currently used.
 *
 * INFO_FREQUENCY
 *   This message can be sent by the player to the jukebox to inform it
 *   what frequency is currently used.
 *
 * INFO_CRC
 *   This message tells the jukebox wether CRC is used in the current audio
 *   file.
 *
 * INFO_COPYRIGHT
 *   This message tells the jukebox wether or not the current file is
 *   copyrighted.
 *
 * INFO_MODE
 *   This message tells the jukebox what mode the current file has.
 *   Mode is stereo = 0, joint-stereo = 1, dual-channel = 2 and single
 *   channel = 3
 *
 * INFO_ORIGINAL
 *   This message tells the jukebox wether or not the audio file is an
 *   original.
 *
 * INFO_IDENT
 *   Well. I started trying to use indices for every kind of audio there is
 *   but that wont work very well I think. This message is composed of two
 *   parts. The first is an ordinary control message with type set to
 *   INFO_IDENT, and data set to the length of the following description.
 *   The description is a short text based description of the audio,
 *   like "Mpeg III/2.0".
 *   Basically, first write the control message, then write the description.
 *
 ************************************************************************
 *
